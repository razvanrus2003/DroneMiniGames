...
//    frag_position = v_position;
    ...
    if (v_position.y > 0.5) {
        v_new_position.x = v_position.x * 0.2;
        v_new_position.z = v_position.z * 0.2;
        v_new_position.y = 0.8;
    } else if (v_position.y > 0.0) {
        v_new_position.x = v_position.x * 0.4;
        v_new_position.z = v_position.z * 0.4;
        v_new_position.y = 0.6;
    } else if (v_position.y > -0.5) {
