...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 2,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  3), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    // RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0, 0.5f, -3), glm::vec3(0.25f));


    // TODO(student): Draw the tetrahedron
    // RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 3, -3), glm::vec3(0.25f));

    // TODO(student): Draw the square
    // RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(3, 3, -3), glm::vec3(0.25f));

    RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1));
