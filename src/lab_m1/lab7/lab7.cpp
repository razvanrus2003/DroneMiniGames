...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3((float)23/255, (float)27/255, (float)142/255));
    }
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3((float)128/255, (float)128/255, (float)128/255));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform3f(light_pos, lightPosition.x, lightPosition.y, lightPosition.z);
    glm::vec3 eyePosition = GetSceneCamera()->m_transform->GetWorldPosition();
    // TODO(student): Set eye position (camera position) uniform
    int camera_pos = glGetUniformLocation(shader->program, "camera_position");
    glUniform3f(camera_pos, eyePosition.x, eyePosition.y, eyePosition.z);
    ...
    int ob_color = glGetUniformLocation(shader->program, "object_color");
    glUniform3f(ob_color, color.x, color.y, color.z);
    // Bind model matrix
